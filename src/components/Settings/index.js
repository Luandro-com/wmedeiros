        ...
        {projects =>
          <div className="Settings">
            <form onSubmit={() => projects.add(postData, push('/'))}>
              ...
              <hr />
              <section className="Settings-images">
                <h3>Imagem</h3>
                <Dropzone className="Settings-dropzone" onDrop={this.onDrop.bind(this)} multiple={false}>
                ...
                <div className="Settings-completed">
              ...
              <section>
                ...
                <input type="email" onChange={(e) => this.setState({ title: e.target.value })} value={title} />
              </section>
              <hr />
              <section>
                <h3>Telefone de contato</h3>
                <input type="phone" onChange={(e) => this.setState({ title: e.target.value })} value={title} />
              </section>
              <br />
              <div>
